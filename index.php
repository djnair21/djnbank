...
<html lang="en">
<head>
   <title>DJN Bank - Money transactions made simple</title>
   <meta charset="utf-8">
            ...
            <div class = "col-md-10 col-12 mx-auto">
                <div class="row">
                    <div class="col-md-6 col-12 main_header_left">
                      <p>Welcome to DJN Banking System</p>
                      <h1>Transfer your <span class="txtColor">Money</span> with ease</h1>
                      <a href="customers.php"> <button>Transfer Now</button></a>
                    </div>
                    <div class="col-md-6 col-12 main_header_right">
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="images/abc1.jpg" class=" w-100" alt="...">
                              </div>
                              <div class="carousel-item">
                                <img src="images/abc.jpg" class=" w-100" alt="...">
                              </div>
                              <div class="carousel-item">
                                <img src="images/lmn.jpg" class=" w-100" alt="...">
                              </div>
                            </div>
